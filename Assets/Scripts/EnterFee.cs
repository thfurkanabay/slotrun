...
public class EnterFee : MonoBehaviour
{
    [Header("UI Elements")]
    public TextMeshProUGUI enterFeeText; // Giriş ücretini göstermek için kullanılan UI Text
    [Header("UI Buttons")]
    ...
    {
        enterFeeText.text = currentFee.ToString();
    }
}